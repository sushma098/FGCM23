...
<MobileElementEntity>
   ...
   <name>android.widget.Button - funnel Filter (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'funnel Filter' or . = 'funnel Filter')]</locator>
